...
\usepackage{capt-of}
\usepackage{hyperref}
\usepackage[citestyle=authoryear,bibstyle=authoryear, hyperref=true,backref=false,maxcitenames=3,url=false,eprint=false,doi=true,backend=biber,natbib=true] {biblatex}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{/Users/ckelty/Desktop/with-companies.png}
